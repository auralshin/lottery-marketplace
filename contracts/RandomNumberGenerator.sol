...
// File: contracts/interfaces/IProjectLottery.sol
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Project lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == ProjectLottery, "Only ProjectLottery");
    ...
    /**
     * @notice Set the address for the ProjectLottery
     * @param _ProjectLottery: address of the Project lottery
     */
    function setLotteryAddress(address _ProjectLottery) external onlyOwner {
        ProjectLottery = _ProjectLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IProjectLottery(ProjectLottery).viewCurrentLotteryId();
    }
}